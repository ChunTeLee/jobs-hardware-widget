...
<style>
  ...
  */
  ...
  #hw-v6-pill {
    ...
    background:rgb(249 250 251);                /* gray-50 = log content tint */
    border:1px solid rgb(229 231 235);          /* gray-200 = card border */
    border-radius:9999px;                       /* horizontal capsule */
    cursor:pointer; user-select:none;
  }
  :where(.dark) #hw-v6-pill {
    background:rgb(17 24 39);                   /* gray-900 */
    border-color:rgb(31 41 55);                 /* gray-800 */
  }
  #hw-v6-pill.hw-v6-expanded {
    ...
    gap:10px; padding:10px;
    box-shadow:0 4px 14px rgba(0,0,0,.12);      /* lifts once it overlays logs */
  }
  :where(.dark) #hw-v6-pill.hw-v6-expanded { box-shadow:0 4px 14px rgba(0,0,0,.35); }
...
(function () {
  ...
  window.hwToggleV6 = function (ev) {
    ...
    if (willExpand) {
      ...
      v6Tl.to(pill,   { height: endHc, borderRadius: 9999, duration: 0.15 }, 0.00)
          .to(sparks, { scaleY: 0, duration: 0.12, stagger: 0.02 }, 0.00)
          .to(aggs,   { yPercent: 130, duration: 0.11, stagger: 0.02 }, 0.02);
    }
  };
