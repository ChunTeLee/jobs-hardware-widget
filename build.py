...
(function () {
  ...
  var ICON = {
    ...
    cancelled: svgIcon('<path d="M16 2A14 14 0 1 0 30 16 14 14 0 0 0 16 2zm0 26A12 12 0 1 1 28 16 12 12 0 0 1 16 28z" fill="currentColor"></path><path d="M12 12h8v8h-8z" fill="currentColor"></path>'),
