...
<style>
  ...
  /* Spacer hidden in V4 — values sit RIGHT AFTER the label (one row-head
     gap apart, 6px) instead of being pushed to the right edge. User
     wants the name + metric value visually grouped. */
  .hw-v4-row-spacer { display:none; }
